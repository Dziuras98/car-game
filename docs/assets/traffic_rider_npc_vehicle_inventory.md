...
| 03 — Renault Clio IV X98 hatchback | `docs/vehicles/traffic/renault_clio_2013.md` | 11 | complete non-R.S. five-door hatchback scope across Phase 1, Phase 2 and Clio Génération: D4F 65/75, H4B TCe 75/90, H5F TCe 120 6MT/EDC, GT 120 EDC, K9K dCi 75/90 5MT, dCi 90 EDC and dCi 110 6MT; no LPG, R.S., Estate, emissions-package or duplicate calibration rows; Phase 2 requires an accurate facelift visual |
...
None. The next research target is model 04 — Chevrolet Cruze 2011. Research must be completed and presented before model 05 begins.
