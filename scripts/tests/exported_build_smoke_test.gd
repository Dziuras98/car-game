...
const CAR_CATALOG: Resource = preload("res://resources/cars/catalog.tres")
...
func _run() -> void:
	...
	_expect(CAR_CATALOG != null, "car catalog is present in the exported package")
	...
	var track: Node = main_instance.get_node_or_null("ProstyOwal")
	_expect(track != null, "generated track exists in the exported main scene")
	if track != null:
