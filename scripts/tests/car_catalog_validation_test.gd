...
func _validate_specs(variant_id_key: String, specs: CarSpecs) -> void:
	...
	_expect(specs.front_axle_track_width > 0.0, "variant %s specs have positive front axle track" % variant_id_key)
	_expect(specs.rear_axle_track_width > 0.0, "variant %s specs have positive rear axle track" % variant_id_key)
	...
	_expect(specs.front_lateral_grip > 0.0, "variant %s specs have positive front lateral grip" % variant_id_key)
	_expect(specs.rear_lateral_grip > 0.0, "variant %s specs have positive rear lateral grip" % variant_id_key)
	_expect(specs.front_tire_width_m > 0.0, "variant %s specs have positive front tyre width" % variant_id_key)
	_expect(specs.rear_tire_width_m > 0.0, "variant %s specs have positive rear tyre width" % variant_id_key)
