...
func _initialize() -> void:
	...
	_expect(tr("GAZ") == "THROTTLE", "English locale translates mobile throttle control")
	_expect(tr("HAMULEC") == "BRAKE", "English locale translates mobile brake control")
	_expect(tr("RĘCZNY") == "HANDBRAKE", "English locale translates mobile handbrake control")
	_expect(tr("KAMERA") == "CAMERA", "English locale translates mobile camera control")
